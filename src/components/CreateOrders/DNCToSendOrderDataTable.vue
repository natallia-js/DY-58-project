...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      // адресатов ДНЦ и назначить им "оригиналы"/"копии" документов, то при переходе на, например, закладку
      // "заявка" без указанного ниже кода будет отображен только сформированный список адресатов ДНЦ,
