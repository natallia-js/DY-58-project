<template>
  <div>
    ...
    <p class="dy58-help-paragraph">
      ...
      для быстрого перехода на форму создания распоряжения о поезде, идущем ДР
    </p>
    <p class="dy58-help-paragraph">
      ...
      для быстрого перехода на форму создания распоряжения о негабаритном поезде
    </p>
    <p class="dy58-help-paragraph">
      ...
      повышенного веса и повышенной длины
    </p>
    <p class="dy58-help-paragraph">
      ...
      количество таких документов равно нулю); находящийся на дежурстве ДНЦ может использовать эту кнопку
      для быстрого перехода на форму создания распоряжения о поезде со взрывчатыми материалами
    </p>
    <p class="dy58-help-paragraph">
    ...
    <p class="dy58-help-paragraph">
      Сделать / отредактировать в журнале распоряжений запись о приеме-сдаче дежурства ДСП может с
      главной страницы ДУ-58 (см. выше описание кнопок бокового меню).
      Делать запись о приеме-сдаче дежурства должен работник, принимающий смену! Если это сделает
      работник, сдающий дежурство, то принявший впоследствии дежурство работник не сможет произвести
    ...
    <p class="dy58-help-paragraph">
      ...
      можно также двойным щелчком мыши по нужному ряду таблицы). Подтвержденный документ переходит в секцию
    ...
    <div class="dy58-help-definition">
      <p class="dy58-help-text">
        ...
        (день назад от текущего времени).
      </p>
    </div>
    <p class="dy58-help-text">
    ...
    <p class="dy58-help-paragraph">
      ...
      на текущем рабочем полигоне, номер отображается в светло-зеленом прямоугольнике; если за номером документа
      следует знак * (звездочка), то такой документ принадлежит цепочке из более чем одного документа
      (более подробно о цепочках документов см. раздел "Страница 'Создать'"); если документ - копия, то
      соответствующая запись (оранжевого цвета) будет следовать за номером документа;
    </p>
    <p class="dy58-help-paragraph">
    ...
    <p class="dy58-help-paragraph">
      - пятый столбец - <i><b>"Наименование"</b></i> - содержит название документа;
    </p>
    <p class="dy58-help-paragraph">
