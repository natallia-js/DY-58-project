<template>
  <div>
    ...
    <p class="dy58-help-paragraph">
      <img :src="require('@/assets/img/newDROrder.png')" class="dy58-help-img-style" />
      - только для находящегося на дежурстве ДНЦ: переход на форму создания распоряжения о поезде,
      идущем ДР
    </p>
    <p class="dy58-help-paragraph">
    ...
    <p class="dy58-help-paragraph">
      ...
      (под <i><b>оперативными</b></i> понимаются <i><b>документы</b></i>, время действия которых еще не закончилось
      либо закончилось не более дня назад).
