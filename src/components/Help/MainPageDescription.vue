<template>
  <div>
    ...
    <p class="dy58-help-paragraph">
      ...
      - количество документов в таблице "Входящие документы" (если на значке нет бейджа с числом, то
    ...
    <h4 id="incoming-notifications-description" class="dy58-help-contents-item">Таблица "Входящие документы"</h4>
    <p class="dy58-help-paragraph">
      Таблица "Входящие документы" предназначена для отображения документов, адресованных текущему рабочему месту.
