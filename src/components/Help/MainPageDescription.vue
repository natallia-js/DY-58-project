<template>
  <div>
    ...
    <p class="dy58-help-paragraph">
      ...
      повышенного веса и повышенной длины (если существует шаблон с отметкой ПВ/ПД/ПВПД)
    </p>
    <p class="dy58-help-paragraph">
    ...
    <div class="dy58-help-definition">
      <p class="dy58-help-text">
        ...
        (время начала действия документа в системе не ранее дня назад от текущего времени).
      </p>
    </div>
    <p class="dy58-help-text">
