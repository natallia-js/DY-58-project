...
export const SET_DEL_ORDER_DRAFT_RESULT = 'setDelOrderDraftResult';
export const CLEAR_SAVE_ORDER_DRAFT_RESULT = 'clearSaveOrderDraftResult';
export const CLEAR_DEL_ORDER_DRAFT_RESULT = 'clearDelOrderDraftResult';
...
export const DEL_ORDER_DRAFT = 'delOrderDraft';
export const SET_DELETED_ORDER_DRAFT_ID = 'setDeletedOrderDraftId';
export const DRAFT_FINISHED_BEING_DELETED = 'draftFinishedBeingDeleted';
