...
export const confirmOrder = {
  ...
  mutations: {
     ...
     *    при ДСП либо иным лицом этой же станции) и список адресатов на станции
     * 2) если подтверждает распоряжение Оператор при ДСП (либо иной работник станции), то подтверждать необходимо в 2 местах:
